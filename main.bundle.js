...
module.exports = "<p>\n  This is my about page. <a (click)=\"sendMeHome()\"><strong>Take me back to home</strong></a>.\n</p>\n<ul class=\"demo\">\n\t<li *ngFor=\"let goal of goals\">\n    {{ goal }}\n  </li>\n</ul>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__http_test_http_test_component__ = __webpack_require__("../../../../../src/app/http-test/http-test.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    {
        path: 'meteo',
        component: __WEBPACK_IMPORTED_MODULE_4__meteo_meteo_component__["a" /* MeteoComponent */]
    },
    {
        path: 'heroes',
        component: __WEBPACK_IMPORTED_MODULE_5__heroes_heroes_component__["a" /* HeroesComponent */]
    },
    {
        path: 'dashboard',
    ...
    {
        path: 'detail/:id',
        component: __WEBPACK_IMPORTED_MODULE_7__hero_detail_hero_detail_component__["a" /* HeroDetailComponent */]
    },
    {
        path: 'http-test',
        component: __WEBPACK_IMPORTED_MODULE_8__http_test_http_test_component__["a" /* HttpTestComponent */]
    }
];
...
module.exports = "<h1>{{title}}</h1>\n<ul>\n  <li><a routerLink=\"\">Home</a></li>\n  <li><a routerLink=\"about/21\">About</a></li>\n  <li>--</li>\n  <li><a routerLink=\"meteo\">Meteo</a></li>\n  <li>--</li>\n  <li><a routerLink=\"dashboard\">Dashboard</a></li>\n  <li><a routerLink=\"heroes\">Heroes</a></li>\n   <li>--</li>\n  <li><a routerLink=\"http-test\">Test HTTP</a></li>\n</ul>\n\n\n<router-outlet></router-outlet>\n\n<app-footer></app-footer>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__weather_service__ = __webpack_require__("../../../../../src/app/weather.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__meteo_meteo_component__ = __webpack_require__("../../../../../src/app/meteo/meteo.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__heroes_heroes_component__ = __webpack_require__("../../../../../src/app/heroes/heroes.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__hero_detail_hero_detail_component__ = __webpack_require__("../../../../../src/app/hero-detail/hero-detail.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__http_test_http_test_component__ = __webpack_require__("../../../../../src/app/http-test/http-test.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_13__meteo_meteo_component__["a" /* MeteoComponent */],
                ...
                __WEBPACK_IMPORTED_MODULE_16__hero_detail_hero_detail_component__["a" /* HeroDetailComponent */],
                ...
                __WEBPACK_IMPORTED_MODULE_20__http_test_http_test_component__["a" /* HttpTestComponent */]
            ],
            imports: [
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_4__weather_service__["a" /* WeatherService */],
...
var DataService = /** @class */ (function () {
    function DataService() {
        this.goals = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["a" /* BehaviorSubject */](['My goal #1 ever', 'My second goal']);
        this.goal = this.goals.asObservable();
    }
    DataService.prototype.changeGoal = function (goal) {
        this.goals.next(goal);
    };
    DataService.prototype.testMe = function () {
...
var HeroDetailComponent = /** @class */ (function () {
    function HeroDetailComponent(route, location, _heroService) {
        this.route = route;
...
var HeroService = /** @class */ (function () {
    function HeroService(_messageService) {
    ...
    HeroService.prototype.getHeroes = function () {
        ...
        return Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_observable_of__["a" /* of */])(__WEBPACK_IMPORTED_MODULE_1__mock_heroes__["a" /* HEROES */]);
    };
    HeroService.prototype.getHero = function (id) {
        // pas ' mais ` car un {} dans la chaine de caractère
        this._messageService.add("HeroService: fetched heroe with id=" + id);
        return Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_observable_of__["a" /* of */])(__WEBPACK_IMPORTED_MODULE_1__mock_heroes__["a" /* HEROES */].find(function (hero) { return hero.id === id; }));
    };
                    ...
                    Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["k" /* transition */])('* => *', [
                        ...
                        Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["g" /* query */])(':enter', Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["i" /* stagger */])('300ms', [
                            Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["e" /* animate */])('.6s ease-in', Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["f" /* keyframes */])([
                                ...
                                Object(__WEBPACK_IMPORTED_MODULE_1__angular_animations__["j" /* style */])({ opacity: 0.5, transform: 'translateY(35px)', offset: .3 }),
...
var HttpTestComponent = /** @class */ (function () {
    function HttpTestComponent(http) {
        this.http = http;
        this.apiRoot = "http://httpbin.org";
    }
    HttpTestComponent.prototype.doGET = function () {
        console.log("GET");
    ...
    HttpTestComponent.prototype.doPOST = function () {
        console.log("POST");
        ...
        params.set('foo', 'moo');
        params.set('limit', '25');
        this.http.post(url, { moo: "foo", goo: "loo" }, { params: params }).subscribe(function (res) { return console.log(res.json()); });
    };
    HttpTestComponent.prototype.doPUT = function () {
        console.log("PUT");
        var url = this.apiRoot + "/put";
        this.http.put(url, { moo: "foo", goo: "loo" }).subscribe(function (res) { return console.log(res.json()); });
        //idem avec params
        //...
    };
    HttpTestComponent.prototype.doDELETE = function () {
        console.log("DELETE");
    ...
    HttpTestComponent.prototype.doGETAsPromise = function () {
    ...
    HttpTestComponent.prototype.doGETAsPromiseError = function () {
        console.log("GET AS PROMISE ERROR");
        var url = this.apiRoot + "/post"; //server will returnn an error
        var search = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["e" /* URLSearchParams */]();
        search.set('foo', 'moo');
        search.set('limit', '25');
        this.http.get(url, { search: search })
            .toPromise()
            .then(function (res) { return console.log(res.json()); })
            .catch(function (msg) { return console.log("Error during request: status(" + msg.status + ") text(" + msg.statusText + ")"); });
    };
    HttpTestComponent.prototype.doGETAsObservableError = function () {
        ...
        search.set('limit', '25');
        this.http.get(url, { search: search })
            .subscribe(function (res) { return console.log(res.json()); }, function (msg) { return console.log("Error during request: status(" + msg.status + ") text(" + msg.statusText + ")"); });
    };
    HttpTestComponent.prototype.doGETWithHeaders = function () {
...
module.exports = "<div *ngIf=\"_messageService.messages.length\">\n\n  <h2>Messages</h2>\n  <button class=\"clear\"\n          (click)=\"_messageService.clear()\">clear</button>\n  <div *ngFor='let message of _messageService.messages'> {{message}} </div>\n\n</div>"
...
module.exports = "<div *ngIf=\"chart\">\n\t<!-- canvas doit match avec canvas dans le .ts-->\n  <canvas id=\"canvas\">{{ chart }}</canvas>\n</div>"
...
var MeteoComponent = /** @class */ (function () {
    function MeteoComponent(_weather) {
